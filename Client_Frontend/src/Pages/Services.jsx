...
const services = [
  ...
  },
  {
  ...
  },
   {
    ...
    category: 'HR Services',
    description: 'Streamline your payroll process and ensure timely, accurate payments for your workforce with our expert payroll management solutions.',
    features: [
      'Automated payroll processing',
      'Compliance with tax regulations',
      'Salary disbursement and reporting',
      'Employee payslip management',
      'Support for multi-location payroll'
    ],
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 10c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8z" />
      </svg>
    )
  }
];
