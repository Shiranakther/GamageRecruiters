...
function SignupPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 via-indigo-800 to-purple-200">
              ...
              >
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                  <div className="form-group">
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-2">
                      This description will be visible to recruiters and helps
                      them understand your qualifications.
                    </p>
                  </div>
                </div>
      ...
      {!loadUI && loadVerifyOTP && (
        <VerifyEmail email={email} dummyEmail={email} />
      )}
    </div>
  );
}
